...
int main() {
    ...
    phekda::HierarchicalNSW<float>* alg_hnsw = new phekda::HierarchicalNSW<float>(&space, max_elements, M, ef_construction, seed, true);
    ...
    ParallelFor(0, num_deleted, num_threads, [&](size_t row, size_t threadId) {
        phekda::LabelType label = max_elements + row;
