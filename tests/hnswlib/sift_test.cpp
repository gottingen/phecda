...
//        LocationType *datal = (LocationType *)(data + 1);
//
//        std::priority_queue< std::pair< float, LocationType >> rez;
//        unordered_set <LocationType> g;
//        for (int j = 0; j < *data; j++) {
//            g.insert(datal[j]);
//        }
//        appr_alg.setEf(400);
//        std::priority_queue< std::pair< float, LocationType >> closest_elements = appr_alg.searchKnnInternal(appr_alg.getDataByInternalId(i), 17);
